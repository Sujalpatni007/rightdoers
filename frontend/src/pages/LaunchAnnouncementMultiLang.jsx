    ...
    >
      ...
      <main className="relative z-10 max-w-6xl mx-auto px-6 pb-20">
        ...
        >
          ...
          {/* WhatsApp - Primary CTA (Large & Prominent) */}
          <motion.div
          ...
          >
            <Button 
              ...
              size="lg"
              className="bg-[#25D366] hover:bg-[#128C7E] text-white px-8 py-6 text-lg shadow-lg shadow-[#25D366]/30"
          ...
          <p className="text-white/50 text-sm mb-4">or share via</p>
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.9 }}
          onClick={handleWhatsAppShare}
          className="fixed bottom-24 right-6 w-16 h-16 rounded-full bg-[#25D366] shadow-lg shadow-[#25D366]/40 flex items-center justify-center z-40"
